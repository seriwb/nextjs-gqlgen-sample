...
type MutationResolver interface {
	...
	UploadImage(ctx context.Context, file graphql.Upload) (*graphql.Upload, error)
}
...
func (ec *executionContext) field_Mutation_createItem_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewItem2githubᚗcomᚋseriwbᚋnextjsᚑgqlgenᚑsampleᚋgraphᚋmodelᚐNewItem(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createItem(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNItem2ᚖgithubᚗcomᚋseriwbᚋnextjsᚑgqlgenᚑsampleᚋgraphᚋmodelᚐItem(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_items(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Item)
	fc.Result = res
	return ec.marshalNItem2ᚕᚖgithubᚗcomᚋseriwbᚋnextjsᚑgqlgenᚑsampleᚋgraphᚋmodelᚐItemᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewItem(ctx context.Context, obj interface{}) (model.NewItem, error) {
	...
	fieldsInOrder := [...]string{"name", "imange"}
	for _, k := range fieldsInOrder {
		...
		case "imange":
			...
			ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("imange"))
			it.Imange, err = ec.unmarshalOUpload2ᚖgithubᚗcomᚋ99designsᚋgqlgenᚋgraphqlᚐUpload(ctx, v)
			if err != nil {
				return it, err
			}
		}
...
func (ec *executionContext) marshalNItem2githubᚗcomᚋseriwbᚋnextjsᚑgqlgenᚑsampleᚋgraphᚋmodelᚐItem(ctx context.Context, sel ast.SelectionSet, v model.Item) graphql.Marshaler {
	return ec._Item(ctx, sel, &v)
}

func (ec *executionContext) marshalNItem2ᚕᚖgithubᚗcomᚋseriwbᚋnextjsᚑgqlgenᚑsampleᚋgraphᚋmodelᚐItemᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Item) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNItem2ᚖgithubᚗcomᚋseriwbᚋnextjsᚑgqlgenᚑsampleᚋgraphᚋmodelᚐItem(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNItem2ᚖgithubᚗcomᚋseriwbᚋnextjsᚑgqlgenᚑsampleᚋgraphᚋmodelᚐItem(ctx context.Context, sel ast.SelectionSet, v *model.Item) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNNewItem2githubᚗcomᚋseriwbᚋnextjsᚑgqlgenᚑsampleᚋgraphᚋmodelᚐNewItem(ctx context.Context, v interface{}) (model.NewItem, error) {
